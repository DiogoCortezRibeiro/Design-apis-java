...
public interface LoanRepository extends JpaRepository<Loan, Long> {
    ...
    @Query(value = " select l from Loan l where l.loanDate <= :thereDaysAgora and (l.returned is null or l.returned is false)")
    List<Loan> findByLoanDateLessThanAndNotReturned(@Param("thereDaysAgora") LocalDate thereDaysAgora);
}
